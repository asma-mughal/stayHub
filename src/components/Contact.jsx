            ...
            <div className="mb-6">
              <input
                ...
                className="border-[f0f0f0]
                 w-full rounded border py-3 px-[14px] text-base 
                 text-body-color outline-none focus:border-black focus-visible:shadow-none"
              />
            </div>
          </>
        );
          ...
          <>
            <div className="mb-6">
              <textarea
                ...
                placeholder={placeholder}
                name={name}
                className="border-[f0f0f0] w-full resize-none 
                rounded border py-3 px-[14px] text-base text-body-color
                 outline-none focus:border-black focus-visible:shadow-none"
                ...
                <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                  <div className="mb-12 max-w-[570px] lg:mb-0">
                    ...
                    <div className="mb-8 flex w-full max-w-[370px]">
                      <div className="mr-6 flex h-[60px] w-full max-w-[60px] items-center
                       justify-center overflow-hidden rounded bg-black bg-opacity-5
                        text-heading sm:h-[70px] sm:max-w-[70px]">
                        <svg
                          width={24}
                          height={24}
                          viewBox="0 0 24 24"
                    ...
                    <div className="mb-8 flex w-full max-w-[370px]">
                      <div className="mr-6 flex h-[60px] w-full max-w-[60px]
                       items-center justify-center overflow-hidden rounded
                       bg-heading bg-opacity-5 text-black sm:h-[70px] sm:max-w-[70px]">
                        <svg
                          width={24}
                          height={26}
                          viewBox="0 0 24 26"
                    ...
                    <div className="mb-8 flex w-full max-w-[370px]">
                      <div className="mr-6 flex h-[60px] 
                      w-full max-w-[60px] items-center justify-center
                       overflow-hidden rounded bg-heading bg-opacity-5 text-black sm:h-[70px] sm:max-w-[70px]">
                        <svg
                          width={28}
                          height={19}
                          viewBox="0 0 28 19"
