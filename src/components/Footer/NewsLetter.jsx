...
const NewsLetter = ({news}) => {
  return (
    ...
    font-poppins
    bg-heading pt-10">
      <div className="mx-auto bg-heading max-w-6xl px-6">
        {news && <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          ...
          items-center
          justify-center
          gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
           <img 
           src={newsLetter}
        ...
        <footer class=" bg-heading  font-poppins">
  <div
    class="max-w-screen-xl space-y-8 py-10 sm:px-6 lg:space-y-16"
  >
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <div class="">
        <img src={logo} alt="logo" className="w-[140px] h-[36px]" />
        </div>
